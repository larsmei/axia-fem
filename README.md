...
**Repo:** [larsmei/axia-fem](https://github.com/larsmei/axia-fem) · **Releases:** [v1.23.0](https://github.com/larsmei/axia-fem/releases/tag/v1.23.0)

## Downloads (CLI 1.23.0)

Fertige Binaries am Release. Archiv enthält `axia` / `axia.exe`, `README`, `LICENSE` und `examples/`.

| Plattform | Datei |
|---|---|
| Windows x64 | [axia-1.23.0-windows-x64.zip](https://github.com/larsmei/axia-fem/releases/download/v1.23.0/axia-1.23.0-windows-x64.zip) |
| Linux x64 (glibc) | [axia-1.23.0-linux-x64.tar.gz](https://github.com/larsmei/axia-fem/releases/download/v1.23.0/axia-1.23.0-linux-x64.tar.gz) |
| Linux x64 (musl, statisch) | [axia-1.23.0-linux-x64-musl.tar.gz](https://github.com/larsmei/axia-fem/releases/download/v1.23.0/axia-1.23.0-linux-x64-musl.tar.gz) |
| Linux ARM64 | [axia-1.23.0-linux-arm64.tar.gz](https://github.com/larsmei/axia-fem/releases/download/v1.23.0/axia-1.23.0-linux-arm64.tar.gz) |
| macOS Apple Silicon | [axia-1.23.0-macos-arm64.tar.gz](https://github.com/larsmei/axia-fem/releases/download/v1.23.0/axia-1.23.0-macos-arm64.tar.gz) |
| macOS Intel | [axia-1.23.0-macos-x64.tar.gz](https://github.com/larsmei/axia-fem/releases/download/v1.23.0/axia-1.23.0-macos-x64.tar.gz) |

Prüfsummen: [SHA256SUMS](https://github.com/larsmei/axia-fem/releases/download/v1.23.0/SHA256SUMS). Standard-Solver ist **faer** (kein Intel-MKL nötig).
