...
| `CQUAD4`/`CQUAD4K`/`CTRIA3`/`CTRIA3K` + `PSHELL` | S4/S3 (MITC4). `12I/T³` skaliert die Biegung. `THETA`/`MCID`. `MID2=-1` wird Membran |
...
| `CTETRA`/`CHEXA`/`CPENTA` + `PSOLID` | C3D4/10, C3D8/20, C3D6/15 |
